...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        # helper dictionary for retrieving by designation and name
        ...
        for neo in self.neos:
            ...
            for approach in self.approaches:
                try:
                    # collects the neo object with the designation saved in the approach object
                    near_earth_object = self.designation_mapper[approach.designation]

                    # add the approach to the neo
                    near_earth_object.approaches.append(approach)

                    # add the neo object to the current approach
